...
List<String> uniquelist =
    Experties.where((experty) => seen.add(experty)).toList();

class _SignupPage_ExpertsState extends State<SignupPage_Experts> {
                        ...
                        children: [
                          Center(
                            child: new DropdownButton(
                              hint: Text(
                                  'Please choose an Experty'), // Not necessary for Option 1
                              value: selectedExperty,
